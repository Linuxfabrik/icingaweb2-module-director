...
class IcingaHost extends IcingaObject implements ExportInterface
{
    ...
    public static function import($plain, Db $db, $replace = false)
    {
        ...
        $table = 'icinga_host'; // since this is a static method we cannot use the class variable $table. redefine it here
        ...
        if (count($candidates) == 1) {
            ...
            throw new DuplicateKeyException(
                'Host Template "%s" with uuid "%s" already exists. This means there is a duplicate uuid in the database. This should never happen.',
                $name,
                $properties['uuid']
            );
        }
